            ...
            <div class="col-md-12" style="text-align: center;">
                <div class="x_panel">
                    <div class="x_title" style="justify-content: center;">
                        <h2>Konfirmasi Hapus data User <a href="{{route('profil.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Kembali </a></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div style="justify-content: center;">
                         <p>Apakah anda yakin hapus  <strong>{{$admin->name}}</strong></p>
                         <p>Setelah terhapus data ini tidak bisa ditambahkan lagi</p>
                        <form method="POST" action="{{ route('profil.destroy', $admin->id) }}">
                            {{ csrf_field() }}
